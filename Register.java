	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try(PrintWriter out = response.getWriter();){
			...
			out.println("<a id=\"link\" href=\"configdata.jsp\"><button class=\"btn btn-primary\">Budget configuration</button></a>    \r\n" + 
					"            </div><div id=\"incomes\">");
			out.println("<h1>"+"INCOMES : "+0.0+"</h1></div>\r\n" + 
					"            <div id=\"expenses\">");
			out.println("<h1>"+"EXPENSES : "+0.0+"</h1></div>\r\n" + 
					"            <div id=\"remaining\">");
			out.println("<h1>"+"REMAINING : "+0.0+"</h1></div>\r\n" + 
					"            <div id=\"savings\">");
			out.println("<h1>"+"SAVINGS : "+0.0+"</h1></div>\r\n" + 
					"       </div>\r\n" + 
					"    </main>\r\n" + 
					"\r\n" + 
					"    <!--Scripts part-->\r\n" + 
