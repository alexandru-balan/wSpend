    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="content">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="sources/team.jsp">Team</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Features</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="sources/pricing.jsp">Pricing</a>
                </li>
                <li class="nav-item">
...
<main>
    ...
    <div id="carouselBanner" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="res/photos/index/budgeting.jpg">
            ...
            <div class="carousel-item">
                <img src="res/photos/index/ion.jpg">
                <div class="carousel-caption d-md-block">
                    <h4>Meet I.O.N.</h4>
            ...
            <div class="carousel-item">
                <img src="res/photos/index/hasslefree.jpg">
                <div class="carousel-caption d-md-block">
                    <h4>Don't stress</h4>
    ...
    <div class="card-deck">
        <div class="card">
            <img class="card-img-top" src="/res/photos/index/glance.jpg">
            <div class="card-body">
        ...
        <div class="card">
            <img class="card-img-top" src="/res/photos/index/family.jpg">
            <div class="card-body">
    ...
    <div class="card-deck">
        <div class="card">
            <img class="card-img-top" src="/res/photos/index/boss.jpg">
            <div class="card-body">
        ...
        <div class="card">
            <img class="card-img-top" src="/res/photos/index/bank.jpg">
            <div class="card-body">
